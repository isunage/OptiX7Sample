...
void TestPG3Application::InitPipelines() {
	{
		...
		m_RGProgramGroups["Trace.Guiding"]				    = m_Pipelines["Trace"].createRaygenPG({   m_Modules["RayTrace"]  , RTLIB_RAYGEN_PROGRAM_STR(pg) });
		...
		m_HGProgramGroups["Trace.Radiance.Diffuse.Guiding"] = m_Pipelines["Trace"].createHitgroupPG({ m_Modules["RayTrace"]  , RTLIB_CLOSESTHIT_PROGRAM_STR(radiance_for_diffuse_pg) }, {}, {});
		...
		m_HGProgramGroups["Trace.Radiance.Phong.Guiding"]   = m_Pipelines["Trace"].createHitgroupPG({ m_Modules["RayTrace"]  , RTLIB_CLOSESTHIT_PROGRAM_STR(radiance_for_phong_pg) }, {}, {});
