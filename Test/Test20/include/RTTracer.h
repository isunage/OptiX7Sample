...
namespace test {
	...
	public:
		...
		using RTStorePipeline    = RTPipeline<RayGenData, MissData, HitgroupData, RayStoreParams>;
		...
		using RTStorePipelinePtr = std::shared_ptr<RTStorePipeline>;
	...
	public:
		...
		void SetStorePipeline(const RTStorePipelinePtr& storePipeline)noexcept;
		...
		auto GetStorePipeline()const -> const RTStorePipelinePtr&;
	...
	private:
		...
		RTStorePipelinePtr m_StorePipeline   = {};
