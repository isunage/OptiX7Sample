...
void test::RTTracer::SetStorePipeline(const RTStorePipelinePtr& storePipeline) noexcept
{
    m_StorePipeline = storePipeline;
}
...
auto test::RTTracer::GetStorePipeline() const -> const RTStorePipelinePtr&
{
    // TODO: return ステートメントをここに挿入します
    return m_StorePipeline;
}
