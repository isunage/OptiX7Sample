#ifndef TEST_TEST22_APPLICATION_H
#define TEST_TEST22_APPLICATION_H
#include <RTApplication.h>
#include <RTTracer.h>
#include <RTFrameBuffer.h>
#include <RTAssets.h>
#include <Test22Config.h>
...
#include <memory>
#include <stdexcept>
class Test22Application :public test::RTApplication
{
private:
...
public:
	static auto  New() -> std::shared_ptr<test::RTApplication> { return std::make_shared<Test22Application>(); }
	// RTApplication ����Čp������܂���
...
private:
	...
	void FreeTracers();
private:
	static auto GetHandleFromWindow(GLFWwindow* window)-> Test22Application* {
		return reinterpret_cast<Test22Application*>(glfwGetWindowUserPointer(window));
	}
