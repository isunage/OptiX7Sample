#include "../include/WRSOPXTracer.h"
#include <RayTrace.h>
#include <fstream>
#include <random>
#include <chrono>
...
// RTTracer ����Čp������܂���
struct Test24WRSOPXTracer::Impl {
	Impl(
		ContextPtr context,
...
Test24WRSOPXTracer::Test24WRSOPXTracer(
	ContextPtr                                  context,
	FramebufferPtr                              framebuffer,
	CameraControllerPtr                         cameraController,
	TextureAssetManager                         textureManager,
	...
	m_Impl = std::make_unique<Test24WRSOPXTracer::Impl>(
		context,
		framebuffer,
		cameraController,
		textureManager,
...
void Test24WRSOPXTracer::Initialize()
{
...
void Test24WRSOPXTracer::Launch(int width, int height, void* pdata)
{
...
void Test24WRSOPXTracer::Update()
{
...
void Test24WRSOPXTracer::InitPipeline()
{
	auto rayTracePtxFile = std::ifstream(TEST_TEST24_WRS_OPX_CUDA_PATH "/RayTrace.ptx", std::ios::binary);
...
void Test24WRSOPXTracer::InitLaunchParams()
{
	auto tlas = this->m_Impl->m_TopLevelAS;
...
void Test24WRSOPXTracer::FreeLight()
{
}

void Test24WRSOPXTracer::FreePipeline()
{
...
void Test24WRSOPXTracer::FreeShaderBindingTable()
{
...
void Test24WRSOPXTracer::FreeLaunchParams()
{
	this->m_Impl->m_Params.Reset();
}

void Test24WRSOPXTracer::FreeFrameResources()
{
