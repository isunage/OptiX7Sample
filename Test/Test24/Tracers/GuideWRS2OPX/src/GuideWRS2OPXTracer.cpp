#include "../include/GuideWRS2OPXTracer.h"
...
Test24GuideWRS2OPXTracer::Test24GuideWRS2OPXTracer(
	ContextPtr context,
	FramebufferPtr framebuffer,
	CameraControllerPtr cameraController,
	TextureAssetManager textureManager,
	...
	m_Impl = std::make_unique<Test24GuideWRS2OPXTracer::Impl>(
		context,
		framebuffer,
		cameraController,
		textureManager,
...
void Test24GuideWRS2OPXTracer::Initialize()
{
...
void Test24GuideWRS2OPXTracer::Launch(int width, int height, void* pdata)
{
...
void Test24GuideWRS2OPXTracer::Update()
{
...
bool Test24GuideWRS2OPXTracer::ShouldLock() const noexcept
{
	return false;
}
...
void Test24GuideWRS2OPXTracer::InitLight()
{
...
void Test24GuideWRS2OPXTracer::InitPipeline()
{
	auto rayGuidePtxFile = std::ifstream(TEST_TEST24_GUIDE_WRS2_OPX_CUDA_PATH "/RayGuide.ptx", std::ios::binary);
...
void Test24GuideWRS2OPXTracer::InitFrameResources()
{
	std::vector<unsigned int> seedData(this->m_Impl->m_Framebuffer.lock()->GetWidth() * this->m_Impl->m_Framebuffer.lock()->GetHeight());
	std::random_device rd;
	std::mt19937 mt(rd());
...
void Test24GuideWRS2OPXTracer::InitShaderBindingTable()
{
	float aspect = static_cast<float>(this->m_Impl->m_Framebuffer.lock()->GetWidth()) / static_cast<float>(this->m_Impl->m_Framebuffer.lock()->GetHeight());
...
void Test24GuideWRS2OPXTracer::InitLaunchParams()
{
	auto tlas = this->m_Impl->m_TopLevelAS.lock();
...
void Test24GuideWRS2OPXTracer::FreeLight()
{
}

void Test24GuideWRS2OPXTracer::InitSdTree()
{
...
void Test24GuideWRS2OPXTracer::FreeSdTree()
{
	m_Impl->m_STree->Clear();
	m_Impl->m_STree.reset();
}

void Test24GuideWRS2OPXTracer::FreePipeline()
{
...
void Test24GuideWRS2OPXTracer::FreeShaderBindingTable()
{
...
void Test24GuideWRS2OPXTracer::FreeLaunchParams()
{
	this->m_Impl->m_Params.Reset();
}

bool Test24GuideWRS2OPXTracer::OnLaunchBegin(int width, int height, UserData* pUserData)
{
...
void Test24GuideWRS2OPXTracer::OnLaunchExecute(int width, int height, UserData* pUserData)
{
	auto curIteration     = GetVariables()->GetUInt32("CurIteration");
...
void Test24GuideWRS2OPXTracer::OnLaunchEnd(int width, int height, UserData* pUserData)
{
	auto samplePerAll    = GetVariables()->GetUInt32("SamplePerAll");
	auto samplePerTmp    = GetVariables()->GetUInt32("SamplePerTmp");
	auto sampleForBudget = GetVariables()->GetUInt32("SampleForBudget");
...
void Test24GuideWRS2OPXTracer::FreeFrameResources()
{
