#ifndef TEST_TEST24_GUIDE_WRS2_OPX_TRACER_H
#define TEST_TEST24_GUIDE_WRS2_OPX_TRACER_H
...
//SimpleTracer
// GuideTracer
class Test24GuideWRS2OPXTracer : public test::RTTracer
{
public:
    struct UserData
    {
...
public:
    ...
    virtual ~Test24GuideWRS2OPXTracer();
