#ifndef TEST_TEST24_GUIDE_OPX_TRACER_H
#define TEST_TEST24_GUIDE_OPX_TRACER_H
...
//SimpleTracer
// GuideTracer
class Test24GuidePathOPXTracer : public test::RTTracer
{
public:
    struct UserData
    {
...
public:
    ...
    virtual ~Test24GuidePathOPXTracer();
