...
void Test24NEEOPXTracer::InitPipeline()
{
	...
	this->m_Impl->m_HGProgramGroups["Trace.Radiance.Diffuse.NEE.Default"] = this->m_Impl->m_Pipeline.createHitgroupPG({ this->m_Impl->m_Modules["RayTrace"], RTLIB_CLOSESTHIT_PROGRAM_STR(radiance_for_diffuse_nee_with_def_light) }, {}, {});
	this->m_Impl->m_HGProgramGroups["Trace.Radiance.Diffuse.NEE.NEE"] = this->m_Impl->m_Pipeline.createHitgroupPG({ this->m_Impl->m_Modules["RayTrace"], RTLIB_CLOSESTHIT_PROGRAM_STR(radiance_for_diffuse_nee_with_nee_light) }, {}, {});
	this->m_Impl->m_HGProgramGroups["Trace.Radiance.Phong.NEE.Default"] = this->m_Impl->m_Pipeline.createHitgroupPG({ this->m_Impl->m_Modules["RayTrace"], RTLIB_CLOSESTHIT_PROGRAM_STR(radiance_for_phong_nee_with_def_light) }, {}, {});
	this->m_Impl->m_HGProgramGroups["Trace.Radiance.Phong.NEE.NEE"] = this->m_Impl->m_Pipeline.createHitgroupPG({ this->m_Impl->m_Modules["RayTrace"], RTLIB_CLOSESTHIT_PROGRAM_STR(radiance_for_phong_nee_with_nee_light) }, {}, {});
	this->m_Impl->m_HGProgramGroups["Trace.Radiance.Emission.Default"] = this->m_Impl->m_Pipeline.createHitgroupPG({ this->m_Impl->m_Modules["RayTrace"], RTLIB_CLOSESTHIT_PROGRAM_STR(radiance_for_emission_with_def_light) }, {}, {});
	this->m_Impl->m_HGProgramGroups["Trace.Radiance.Emission.NEE"] = this->m_Impl->m_Pipeline.createHitgroupPG({ this->m_Impl->m_Modules["RayTrace"], RTLIB_CLOSESTHIT_PROGRAM_STR(radiance_for_emission_with_nee_light) }, {}, {});
