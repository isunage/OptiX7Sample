...
void Test24GuideReSTIROPXTracer::Launch(int width, int height, void* pdata)
{
...
bool Test24GuideReSTIROPXTracer::ShouldLock() const noexcept
{
	return false;
}
...
{
	auto rayGuidePtxFile = std::ifstream(TEST_TEST24_GUIDE_RESTIR_OPX_CUDA_PATH "/RayGuide.ptx", std::ios::binary);
...
void Test24GuideReSTIROPXTracer::InitSdTree()
{
...
void Test24GuideReSTIROPXTracer::FreeSdTree()
{
...
bool Test24GuideReSTIROPXTracer::OnLaunchBegin(int width, int height, UserData* pUserData)
{
...
void Test24GuideReSTIROPXTracer::OnLaunchEnd(int width, int height, UserData* pUserData)
{
	auto samplePerAll    = GetVariables()->GetUInt32("SamplePerAll");
	auto samplePerTmp    = GetVariables()->GetUInt32("SamplePerTmp");
	auto sampleForBudget = GetVariables()->GetUInt32("SampleForBudget");
