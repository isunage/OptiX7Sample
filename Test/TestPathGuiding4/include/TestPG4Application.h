#ifndef TEST_TEST_PG4_APPLICATION_H
#define TEST_TEST_PG4_APPLICATION_H
...
#include <memory>
#include <stdexcept>
class TestPG4Application :public test::RTApplication
{
private:
...
private:
	...
	void FreeTracers();
private:
	static auto GetHandleFromWindow(GLFWwindow* window)-> TestPG4Application* {
		return reinterpret_cast<TestPG4Application*>(glfwGetWindowUserPointer(window));
	}
